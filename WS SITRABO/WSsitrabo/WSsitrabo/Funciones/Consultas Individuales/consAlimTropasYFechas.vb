...
Module consAlimTropasYFechas
    Public Function Ver(ByVal IdT As Integer, ByVal Fd As Date, ByVal Fh As Date) As mdlAlimentacionProrateo
        ...
        Try
            Using Conn As MySqlConnection = New MySqlConnection(Servidor)
                Cmd = New MySqlCommand("feedlot.consAlimTropasYFechas")
