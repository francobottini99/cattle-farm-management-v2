Public Class frmConsAlimentacion
    ...
    Private Sub btnFiltrar_Click(sender As Object, e As EventArgs) Handles btnFiltrar.Click
        If (chbFdesde.Checked = True Or chbFhasta.Checked = True) And (chbProd.Checked = False And chbTropa.Checked = False And chbCorral.Checked = False And chbCarav.Checked = False) Then
            If Format(CDate(dtmFdesde.Text), "yyyy/MM/dd") <= Format(CDate(dtmFhasta.Text), "yyyy/MM/dd") Then
                ...
                LabelsTotales(lblKgran, lblKconc, lblKfib, lblKotr, lblKtot, lblImpGr, lblImpConc, lblImpFib, lblImpOtr, lblImpTot, lblPorGr, lblPorcConc, lblPorFib, lblPorOtro, "Fecha")
        ...
        ElseIf ((chbFdesde.Checked = False And chbFhasta.Checked = False) Or (chbFdesde.Checked = True Or chbFhasta.Checked = True)) And (chbProd.Checked = False And chbTropa.Checked = True And chbCarav.Checked = False And chbCorral.Checked = False) Then
            If cbxTropa.Text <> "" Then
                ...
                LabelsTotales(lblKgGrT, lblKgConcT, lblKgFibT, lblKgOtrT, lblKgTotT, lblImpGrT, lblImpConcT, lblImpFibT, lblImpOtrT, lblImpTotT, lblPorGrT, lblPorConcT, lblPorFibT, lblPorOtrT, "Tropa")
        ...
        ElseIf ((chbFdesde.Checked = False And chbFhasta.Checked = False) Or (chbFdesde.Checked = True Or chbFhasta.Checked = True)) And (chbProd.Checked = True And chbTropa.Checked = False And chbCarav.Checked = False And chbCorral.Checked = False) Then
            If cbxProductor.Text <> "" Then
                ...
                LabelsTotales(lblKgGr, lblKgConc, lblKgFib, lblKgOtr, lblKgT, lblImGr, lblImCon, lblImFib, lblImOtr, lblImTot, lblPgr, lblPconc, lblPfib, lblPotr, "Productor")
        ...
        ElseIf ((chbFdesde.Checked = False And chbFhasta.Checked = False) Or (chbFdesde.Checked = True Or chbFhasta.Checked = True)) And (chbProd.Checked = False And chbTropa.Checked = False And chbCarav.Checked = False And chbCorral.Checked = True) Then
            If cbxCorral.Text <> "" Then
                ...
                LabelsTotales(lblKgG, lblKgC, lblKgF, lblKgO, lblKgTT, lblImG, lblImC, lblImF, lblImO, lblImTT, lblPG, lblPC, lblPF, lblPO, "Corral")
        ...
        ElseIf ((chbFdesde.Checked = False And chbFhasta.Checked = False) Or (chbFdesde.Checked = True Or chbFhasta.Checked = True)) And (chbProd.Checked = False And chbTropa.Checked = False And chbCarav.Checked = True And chbCorral.Checked = False) Then
            If txtCaravana.Text <> "" Then
                ...
                LabelsTotales(lblCarKgGr, lblCarKgCon, lblCarKgFib, lblCarKgOtr, lblCarKgTot, lblCarImGr, lblCarImCon, lblCarImFib, lblCarImOtr, lblCarImTot, lblCarPorGr, lblCarPorConc, lblCarPorFib, lblCarPorOtr, "Caravana")
    ...
    Private Sub LabelsTotales(ByVal lblKgGrano As Label, ByVal lblKgConcentrado As Label, ByVal lblKgFibra As Label, _
                              ByVal lblKgOtros As Label, ByVal lblKgTotales As Label, ByVal lblImpGrano As Label, _
                              ByVal lblImpConcentrado As Label, ByVal lblImpFibra As Label, ByVal lblImpOtros As Label, _
                              ByVal lblImpTotal As Label, ByVal lblPorcGrano As Label, ByVal lblPorcConcentrado As Label, _
    ...
    Private Sub CargarDetalleAlim()
        ...
        Dim kgGrano, kgConcentrado, kgFibra, kgOtros, kgTotales As Double
        Dim costGrano, costConcentrado, costFibra, costOtros, costTotal As Double
        Dim porcGrano, porcConcentrado, porcFibra, porcOtros As Double
