...
Public Class frmAltasRaciones
    ...
    Private Sub CargarDGV()
        ...
        dgvRaciones.Columns("Silo").Visible = False
        ...
        dgvRaciones.Columns("CostoSilo").Visible = False
                            ...
                            Else
                                ...
                                If resP = Windows.Forms.DialogResult.OK Then
                                    If txtOrigen.Text = "Nuevo" Then
                                        ...
                                        G.Grabar("Raciones", "NoImagen", "feedlot.insRacion", txtRacion.Text, txtGrano.Text, txtSilo.Text, txtConcentrado.Text, txtFibra.Text,
                                                 txtOtros.Text, CDbl(txtCostGrano.Text), CDbl(txtCostoSilo.Text), CDbl(txtCostConcentrado.Text), CDbl(txtCostFibra.Text),
                                                 CDbl(txtCostOtros.Text), CDbl(frmLogin.txtID.Text))
                                    ...
                                    Else
                                        ...
                                        G.Grabar("Raciones", "NoImagen", "feedlot.modRacion", CInt(txtID.Text), txtRacion.Text, txtGrano.Text, txtSilo.Text, txtConcentrado.Text, txtFibra.Text,
                                                 txtOtros.Text, CDbl(txtCostGrano.Text), CDbl(txtCostoSilo.Text), CDbl(txtCostConcentrado.Text), CDbl(txtCostFibra.Text),
    ...
    Private Sub txtSilo_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtSilo.KeyPress
        If Asc(e.KeyChar) = Keys.Enter Then
            e.Handled = True
            txtSilo.SelectionLength = Len(txtSilo.Text)
            txtCostoSilo.Select()
        End If
    End Sub

    Private Sub txtCostoSilo_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtCostoSilo.KeyPress
        If Not IsNumeric(e.KeyChar) And Asc(e.KeyChar) <> Keys.Enter And e.KeyChar <> ChrW(8) And e.KeyChar <> ChrW(46) Then
            e.Handled = True
        ElseIf Asc(e.KeyChar) = Keys.Enter Then
            e.Handled = True
            txtCostoSilo.SelectionLength = Len(txtCostoSilo.Text)
            txtConcentrado.Select()
        End If
    End Sub
    ...
    Private Sub dgvRaciones_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvRaciones.CellClick
        If gbxD.Enabled = False Then
            ...
            txtSilo.Text = dgvRaciones.CurrentRow.Cells.Item(3).Value
            txtConcentrado.Text = dgvRaciones.CurrentRow.Cells.Item(4).Value
            txtFibra.Text = dgvRaciones.CurrentRow.Cells.Item(5).Value
            txtOtros.Text = dgvRaciones.CurrentRow.Cells.Item(6).Value
            txtCostGrano.Text = dgvRaciones.CurrentRow.Cells.Item(7).Value
            txtCostoSilo.Text = dgvRaciones.CurrentRow.Cells.Item(8).Value
            txtCostConcentrado.Text = dgvRaciones.CurrentRow.Cells.Item(9).Value
            txtCostFibra.Text = dgvRaciones.CurrentRow.Cells.Item(10).Value
            txtCostOtros.Text = dgvRaciones.CurrentRow.Cells.Item(11).Value

            If txtCostGrano.Text <> "" Then
                txtCostGrano.Text = Format(CDbl(txtCostGrano.Text), "$ #,##0.00")
            End If

            If txtCostoSilo.Text <> "" Then
                txtCostoSilo.Text = Format(CDbl(txtCostoSilo.Text), "$ #,##0.00")
            End If
    ...
    Private Sub pbxModificar_Click(sender As Object, e As EventArgs) Handles pbxModificar.Click
        If txtRacion.Text <> "" Then
            If dgvRaciones.CurrentRow.Cells.Item(12).Value = frmLogin.txtID.Text Then
                Activar()
    ...
    Private Sub txtCostoSilo_Validated(sender As Object, e As EventArgs) Handles txtCostoSilo.Validated
        If txtCostoSilo.Text <> "" Then
            txtCostoSilo.Text = Format(CDbl(txtCostoSilo.Text), "$ #,##0.00")
        End If
    End Sub
